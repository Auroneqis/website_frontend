...
export default function Home() {
  return (
    <>
      ...
      <Helmet>
        <title>
          Auroneqis | AI Solutions, Software Development &
          Digital Transformation
        </title>

        <meta
          name="description"
          content="Auroneqis provides AI solutions, software development, web development, mobile applications, cloud solutions, software testing and IT consulting services."
        />
      </Helmet>
